...
- Drawing/Whiteboard files are directly exported from iOS Bamboo, Inkpad, GIMP, etc. and committed here with a comment regarding its contents.
- We avoid timelines here.
- Not all initial investigations into requirements in these documents are required for projects, including phase 1, v1.0.0 Jonah release.
